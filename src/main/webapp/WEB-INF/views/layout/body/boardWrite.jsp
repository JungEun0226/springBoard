			...
			<div class="w3-twothird w3-container" style="width: 88%;">
				...
				<form class="form-horizontal" action="${root}/boardWriteOk.com" method="post" style="font-size: 20px;" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<textarea class="form-control col-sm-10" rows="7" id="content" style="width: 81%; margin-left: 15px;"></textarea>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2" for="content">파일첨부:</label>
						<input type="file" name="file" id="fileUpload" style="padding-left: 15px;"/>
					</div>
					<input type="hidden" value="${membernumber}" id="membernumber"/>
					<div class="form-group" style="text-align: end;">
						<div class="col-sm-offset-2 col-sm-10">
							<input id="writeButton" type="submit" value="등록" class="btn btn-primary" style="font-size: 20px; color: black; background-color: #f0f0f0 !important; border-color: lightgrey;"/>
						</div>
					</div>
				</form>
